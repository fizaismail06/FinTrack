...
function renderTrends(){
  ...
  if(!selected.length) return `<div class="screen"><div style="height:8px"></div>${chipsHtml}<div class="empty">Select at least one year</div></div>`;
...
function renderInsights(){
  if(CUR.insightsMode==='trends') return renderTrends();
  const isMonth = CUR.insightsMode==='month';
  ...
  return `<div class="screen">
    <div style="height:8px"></div>
    <div class="tabs">
      <div class="tab ${isMonth?'active':''}" data-insmode="month">Month</div>
      <div class="tab ${!isMonth&&CUR.insightsMode!=='trends'?'active':''}" data-insmode="year">Year</div>
      <div class="tab" data-insmode="trends">Trends</div>
    </div>
